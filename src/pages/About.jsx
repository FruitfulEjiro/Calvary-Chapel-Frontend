      ...
      <>
         ...
         <main className="pt-4 pt-xxs-5">
            <section className="about-hero">
               <img src={aboutImg} alt="" className="about-hero-img" />
            ...
            <section className="about-container py-3">
               <Outlet />
            </section>
         </main>
         <Footer />
